...
ENDPOINT_PERMISSIONS: dict[Callable, list[str] | set[str] | str] = {
    ...
    rcon_api.reset_votemap_seeding_whitelist: "api.can_reset_map_whitelist",
    ...
    rcon_api.set_votemap_seeding_whitelist_warfare: "api.can_set_map_whitelist",
    rcon_api.set_votemap_seeding_whitelist_offensive: "api.can_set_map_whitelist",
    ...
    rcon_api.get_votemap_seeding_whitelist: "api.can_view_map_whitelist",
    rcon_api.get_votemap_seeding_config: "api.can_view_votemap_config",
    ...
    rcon_api.set_votemap_seeding_config: "api.can_change_votemap_config",
    ...
    rcon_api.validate_votemap_seeding_config: "api.can_change_votemap_config",
...
RCON_ENDPOINT_HTTP_METHODS: dict[Callable, list[str]] = {
    ...
    rcon_api.get_votemap_seeding_whitelist: ["GET"],
    rcon_api.get_votemap_seeding_config: ["GET"],
    ...
    rcon_api.reset_votemap_seeding_whitelist: ["POST"],
    ...
    rcon_api.set_votemap_seeding_whitelist_warfare: ["POST"],
    rcon_api.set_votemap_seeding_whitelist_offensive: ["POST"],
    ...
    rcon_api.set_votemap_seeding_config: ["POST"],
    ...
    rcon_api.validate_votemap_seeding_config: ["POST"],
