    ...
    <div className="max-w-6xl mx-auto p-6">
      <header className="mb-6">
        ...
        <p className="text-zinc-400 text-sm">
          {data.length} архетипів • {totalPrimary.toLocaleString('uk-UA')} класифікованих гравців
          • На картці: основних / усіх що підходять
        </p>
      </header>
            ...
            return (
              <Link key={ps.id} to={`/playstyles/${ps.id}`}
                ...
                <div className="flex items-baseline gap-2 mb-1">
                  ...
                  <span className="text-sm tabular-nums text-zinc-200" title="основних / усіх що підходять">
                ...
                <div className="flex items-center justify-between text-xs">
                  <span className="text-zinc-500">{pct.toFixed(1)}% основних</span>
                </div>
