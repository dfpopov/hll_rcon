...
export const cmd = {
  ...
  GET_VOTEMAP_SEEDING_WHITELIST: (params) => requestFactory({ method: "GET", cmd: "get_votemap_seeding_whitelist", ...params }),
  GET_VOTEMAP_SEEDING_CONFIG: (params) => requestFactory({ method: "GET", cmd: "get_votemap_seeding_config", ...params }),
  ...
  RESET_VOTEMAP_SEEDING_WHITELIST: (params) => requestFactory({ method: "POST", cmd: "reset_votemap_seeding_whitelist", ...params }),
  ...
  SET_VOTEMAP_SEEDING_WHITELIST_WARFARE: (params) => requestFactory({ method: "POST", cmd: "set_votemap_seeding_whitelist_warfare", ...params }),
  SET_VOTEMAP_SEEDING_WHITELIST_OFFENSIVE: (params) => requestFactory({ method: "POST", cmd: "set_votemap_seeding_whitelist_offensive", ...params }),
  SET_VOTEMAP_SEEDING_CONFIG: (params) => requestFactory({ method: "POST", cmd: "set_votemap_seeding_config", ...params }),
